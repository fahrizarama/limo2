...
class Gallery extends CI_Controller
{
    ...
    public function ajax_add()
    {
        ...
        $nama_gambar = str_replace(' ', '_', $_FILES['userfile']['name']);
    ...
    public function upload_update()
    {
        ...
        // $config['max_width'] = '2024';
        // $config['max_height']= '1468';
        $config['file_name'] = str_replace(' ', '_', $_FILES['file-upload']['name']);
        $nama_gambar = str_replace(' ', '_', $_FILES['file-upload']['name']);
    ...
    public function gallery_detail($key)
    {
